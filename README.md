...
* **Distributed Inference:** The Jetson packages the text string and forwards it via a network POST request to Ollama listening on the Quantum PC (192.168.1.150:11434). The RTX 5070 processes the prompt through an 8B context window and returns a text block response.
